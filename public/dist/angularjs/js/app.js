...
conAngular.config(function($authProvider){
  $authProvider.loginUrl = '/api/authenticate';
});

conAngular.config(function($stateProvider, $urlRouterProvider, $authProvider, $httpProvider, $provide) {
...
conAngular.run(function($rootScope, $state) {
...
// Navbar Controller
conAngular.controller('NavbarController', function($scope,$auth,$rootScope) {
...
conAngular.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
 ...
 // $urlRouterProvider.otherwise("/dashboard.html");
  ...
  $urlRouterProvider.otherwise('/task_app.html');
  ...
  $stateProvider
    ...
    // Angular Options
      .state('/task_app', {
        url: "/task_app.html",
        templateUrl: "tpl/task_app.html",
        controller: "TaskController",
        data: {
          pageTitle: 'Task application',
          crumbs: [{
            title: '<i class="fa fa-home"></i> Task',
            href: '#'
          }, {
            title: 'Task APP',
            href: '#/task_app.html'
